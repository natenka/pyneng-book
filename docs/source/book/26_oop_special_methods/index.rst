...
на английском их часто называют dunder методы, сокращенно от "duble underscore".
...
создание итераторов и итерируемых объектов, операции сложения, умножения и других.
