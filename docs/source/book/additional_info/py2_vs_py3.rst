...
`Unicode <../16_unicode/README.md>`__
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
`Функция print <../10_useful_functions/print.md>`__
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
`input вместо raw\_input <../05_basic_scripts/2_user_input.md>`__
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

В Python 2.7 для получения информации от пользователя в виде строки
использовалась функция raw\_input:
...
`range вместо xrange <../10_useful_functions/range.md>`__
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

В Python 2.7 были две функции \* range - возвращает список \* xrange -
возвращает итератор
...
`Методы словарей <../04_data_structures/6a_dict_methods.md>`__
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
В Python 3 нет методов: \* viewitems, viewkeys, viewvalues \* iteritems,
iterkeys, itervalues
...
`Распаковка переменных <../08_python_basic_examples/variable_unpacking.md>`__
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
`Итератор вместо списка <../10_useful_functions/README.md>`__
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
`subprocess.run <../12_useful_modules/subprocess.md>`__
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
