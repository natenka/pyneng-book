...
**Оператор break** позволяет досрочно прервать цикл: \* break прерывает
текущий цикл и продолжает выполнение следующих выражений \* если
используется несколько вложенных циклов, break прерывает внутренний цикл
и продолжает выполнять выражения, следующие за блоком \* break может
использоваться в циклах for и while
...
check\_password\_with\_while\_continue.py):
...
password\_correct. Когда был введен правильный пароль, флаг выставляется
