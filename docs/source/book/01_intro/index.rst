...
Для выполнения заданий в книге можно сделать отдельную виртуальную
машину или работать на хосте. С подготовкой виртуальной машины есть несколько вариантов:
